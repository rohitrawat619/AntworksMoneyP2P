<?php
class Brating extends CI_Model
{
...
//            'Variety_of_Loans_including_Closed'=>$variety_of_loans_including_closed_arr,
        ...
        $result_experian_sum = array(
            ...
            'leverage_ratio_maximum_available_credit'=>$leveraging_ratio_max_available_credit_arr['system_score']?$leveraging_ratio_max_available_credit_arr['system_score']:'',
            'limit_utilization_revolving_credit'=>$limit_utilization_arr['system_score']?$limit_utilization_arr['system_score']:'',
            ...
            'outstanding_to_limit_term_credit_including_past_facilities'=>$outstanding_to_limit_including_past_facilities_arr['system_score']?$outstanding_to_limit_including_past_facilities_arr['system_score']:'',
...
//            'Unsecured_Facilities_to_Total_Credit'=>$unsecured_facilities_to_total_credit_arr,
            ...
            'no_of_active_accounts'=>$no_of_active_account_arr['system_score']?$no_of_active_account_arr['system_score']:'',
...
//            'Variety_of_Loans_including_Closed'=>$variety_of_loans_including_closed_arr,
        ...
        {
            $result_experian_sum['highest_qualification'] = 0;
        }
        if($borrower_info['highest_qualification'] == 2)
        {
            $result_experian_sum['highest_qualification'] = 5;
        }
        if($borrower_info['highest_qualification'] == 3)
        {
            $result_experian_sum['highest_qualification'] = 8;
        }
        if($borrower_info['highest_qualification'] == 4)
        {
            $result_experian_sum['highest_qualification'] = 10;
        }
        ...
        $result_experian_sum['savings_as_percentage_of_annual_income'] = 5;
