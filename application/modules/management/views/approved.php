                                ...
                                <? 	if($list){
                                    ...
                                    foreach($list as $row){
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=base_url();?>management/showcase?proposal_id=<?=$row['bid_registration_id'];?>"><button type="submit" class="btn btn-sm btn-icon btn-pure btn-outline">View</button></a></td>
                                        </tr>
                                        <? $i++;}}else
                                {?>
                                    <tr>
