                                ...
                                <? 	if($list){
                                    ...
                                    foreach($list as $row){
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$row['borrower'];?></td>
                                            <td><?=$row['amount'];?></td>
                                            <td><?=$row['percentamount'];?></td>
                                            <?php
                                            $amount = ($row['amount']*$row['percentamount'])/100;
                                            ?>
                                            <td><?=$amount;?></td>
                                            <td><?=$row['interest_rate'];?></td>
                                            <td><a href="<?=base_url();?>/#?>"><button type="submit" class="btn btn-sm btn-icon btn-pure btn-outline" title="Delete">Active</button></a></td>
                                        </tr>
                                        <? $i++;}}else
                                {?>
                                    <tr>
