						...
						<div class="right-page-header">
							<form method="post" id="search_admin">
								<div class="col-md-12">
									...
									<div class="col-md-3">
										<div class="form-group">
											<input type="text" name="pan" placeholder="Pancard" class="form-control"
												   id="pan">
										</div>
									</div>
									<div class="col-md-3">
									...
									<div class="col-md-3">
										<div class="form-group">
											<input type="hidden" name="action_uri" value="documentmanagement/borrower/viewborrower/">
											<input type="button" id="search_by_admin" value="Search"
												   name="search_by_admin" class="btn btn-primary">
								...
								<? if ($list) {
									...
									foreach ($list as $row) {
										...
										<tr>
											...
											<td>
												<a href="<?= base_url(); ?>documentmanagement/borrower/viewborrower/<?= $row['borrower_id']; ?>"> <?= $row['name']; ?></a>
											</td>
											<td><?= $row['email']; ?></td>
											<td><?= $ff = date('Y-m-d', strtotime($row['created_date'])); ?></td>
											<td><?php if ($row['step_2'] == 1) {
													echo "Payment Done";
												} else {
