					  ...
					  <div class="card-body">
					   <form method="post" autocomplete="off" action="<?=base_url('Surgeadmin/vend_addschemenow')?>">
					   	<div class="mb-3">
						    ...
						    <input type="text" placeholder="Scheme_Name" name="Scheme_Name" class="form-control" id="Scheme_Name" aria-describedby="Scheme_Name" required>
                            </div>
                            <br>
                            <div class="mb-3">
						    ...
						    <input type="text"  placeholder="Min_Inv_Amount" name="Min_Inv_Amount" class="form-control" id="Min_Inv_Amount" aria-describedby="Min_Inv_Amount" required>
						  </div>
                          <div class="mb-3">
						    <label for="exampleInputEmail1" class="form-label">Maximum Invest Ammount</label>
						    <input type="text"  placeholder="Max_Inv_Amount" name="Max_Inv_Amount" class="form-control" id="Max_Inv_Amount" aria-describedby="Max_Inv_Amount" required>
						  </div>
                          <div class="mb-3">
						    <label for="exampleInputEmail1" class="form-label">Aggretate Invest Ammount</label>
						    <input type="text"  placeholder="Aggregate_Amount" name="Aggregate_Amount" class="form-control" id="Aggregate_Amount" aria-describedby="Aggregate_Amount" required>
						  </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
						    ...
						    <input type="text"  placeholder="Interest_Rate" name="Interest_Rate" class="form-control" id="Interest_Rate" aria-describedby="Interest_Rate" required>
                            </div>
                            <div class="mb-3">
						    <label for="exampleInputEmail1" class="form-label">Pre-Mature Interest Rate</label>
						    <input type="text"  placeholder="Pre_Mat_Rate" name="Pre_Mat_Rate" class="form-control" id="Pre_Mat_Rate" aria-describedby="Pre_Mat_Rate" required>
						  </div>
                          <div class="mb-3">
