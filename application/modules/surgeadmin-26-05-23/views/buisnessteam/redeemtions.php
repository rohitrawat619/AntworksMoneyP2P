...
foreach($row as $row1)   { ?>
        ...
        <tr>
            ...
            <td><a style="background-color:green; color:black; padding: 0.5em 2rem;" href="<?= base_url(); ?>Surgeadmin/editrepersent/<?= $row1['rid']; ?>"> Edit</a></td>
<td><a style="background-color:red; color:black; padding: 0.5em;" href="<?= base_url(); ?>Surgeadmin/deleterepersent/<?=$row1['rid']; ?>">Delete</a></td>
