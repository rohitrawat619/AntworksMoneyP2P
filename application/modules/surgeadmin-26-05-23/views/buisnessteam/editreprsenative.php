					  ...
					  <div class="card-body">
					   <form method="post" autocomplete="off" action="<?=base_url('Surgeadmin/updaterepersent')?>">
						  ...
						  <option value=''>--Select Vender --</option>
                                 <option value='jitendra dddd' <?php if ($representlist['rid'] == "34") {
                                    echo "selected"; } ?>>jitendrapal dddd
                                </option>
								 <option value='rahul kumar' <?php if ($representlist['rid'] == "36") {
                                    echo "selected"; } ?>>rahul kumar
                                </option>
								 <option value='vikash sir' <?php if ($representlist['rid'] == "39") {
                                    echo "selected"; } ?>>vikash sir
                                </option>
