                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-inline">
                            <div class="box-body">
                                <h3>Lead Closed</h3>
                                <form action="<?php echo base_url(); ?>teamleader/leadclosed" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-inline">
                            <div class="box-body">
                                <h3>Lead Reassign</h3>
                                <form action="<?php echo base_url(); ?>teamleader/leadcreassign" method="post" enctype="multipart/form-data">
