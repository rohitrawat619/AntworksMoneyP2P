      ...
      <div class="page-aside">
          <div class="m-t-30">
              <div class="right-page-header">
                  <form method="post" action="<?php echo base_url(); ?>creditops/pending_search/">
                      <div class="col-md-12">
                          <div class="col-md-3">
						  ...
						  <div class="col-md-3">
							  <div class="form-group">
								  <input type="text" name="name" placeholder="Borrower Name" class="form-control" id="name">
							  </div>
						  </div>
                          <div class="col-md-3">
                              <div class="form-group">
