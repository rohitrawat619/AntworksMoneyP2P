...
{			
	...
	public function dashboard(){	
		...
		//  print_r($this->session->userdata('role'));
			...
			$data['lists']['dashboardData']['TodayInvestmentNoOfInvestor'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['TodayRedemption'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['TodayRedemptionNoOfInvestor'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");

			$data['lists']['dashboardData']['TotalInvestment'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0),"");
			$data['lists']['dashboardData']['TotalInvestmentOutstanding'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['TotalInvestmentRedeemed'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['TotalInvestmentInvestor'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['AverageROI'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['InterestOutstanding'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['TotalInterestPaidOnRedeemedInvestment'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['AverageInvestment'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
			$data['lists']['dashboardData']['OutstandingInvestmentNoInvestor'] = $this->Surgemodel->getDashboardDataCount("p2p_lender_reinvestment",array("redemption_status"=>0, 'Date(created_date)'=>date("Y-m-d")),"");
	...
	public function partners_list(){
			...
			$where = ""; 
		$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/partners_list";
			...
			$updateThemeResp = $this->Surgemodel->update_theme($partners_id,$uploadImageResp['full_path']);
					...
					if($updateThemeResp['status']==1){
						$this->session->set_flashdata('notification', array('error' => 0, 'message' => $updateThemeResp['msg']));
							redirect(base_url() . 'surgeModule/surge/add_partners_form?id='.$partners_id);
					}else{
   ...
   $config['max_width'] = 1024;
    ...
    if ($this->upload->do_upload('partner_logo_file')){
		...
		public function lender_list(){
					$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/lender_list";
		...
		public function scheme_list(){
						$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/scheme_list";
			...
			$scheme_id = $updateSchemeResp['scheme_id'];
					...
					if($updateSchemeResp['status']==1){
						$this->session->set_flashdata('notification', array('error' => 0, 'message' => $updateSchemeResp['msg']));
							redirect(base_url() . 'surgeModule/surge/add_scheme_form?id='.$scheme_id);
					}else{
		...
		$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/user_list";
		...
		public function redemption_list_pending(){
			$status = array(1); // approval pending
							$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/redemption_list_pending";
		...
		public function redemption_list_generate_bank_file(){
			...
			$status = array(5);// pending for genertion of redemption file
							$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/redemption_list_generate_bank_file";
		$config["total_rows"] = $this->Surgemodel->getCountRedemptionListStatus($status,$this->vendor_id);
		$config["per_page"] = 20;
		$config["uri_segment"] = 4;
		...
		$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/redemption_list_under_process";
		$config["total_rows"] = $this->Surgemodel->getCountRedemptionListStatus($status,$this->vendor_id);
		$config["per_page"] = 20;
		$config["uri_segment"] = 4;
		$this->pagination->initialize($config);
		...
		public function redemption_list_redeemed(){
			$status = array(4);
		$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/redemption_list_redeemed";
		$config["total_rows"] = $this->Surgemodel->getCountRedemptionListStatus($status,$this->vendor_id);
		$config["per_page"] = 20;
		$config["uri_segment"] = 4;
		$this->pagination->initialize($config);
		...
		$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/investment_list";
		$config["total_rows"] = $this->Surgemodel->getCountRedemptionListStatus($status,$this->vendor_id);
		$config["per_page"] = 20;
		$config["uri_segment"] = 4;
		$this->pagination->initialize($config);
		...
		public function ticket_list(){
				$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/ticket_list";
	...
	//	echo $page;
		...
		$this->load->view('template-surgeModule/footer');
			...
			public function ticket_detail_form(){
				$config = array();
		$config["base_url"] = base_url() . "surgeModule/surge/ticket_detail_form";
	...
	//	print_r($data['lists']);
		...
		public function insert_raise_ticket(){
			...
			redirect(base_url() . 'surgeModule/surge/raise_ticket');
		...
		public function comment_ticket(){
			...
			$this->session->set_flashdata('notification', array('error' => 0, 'message' => $msg));
			redirect(base_url() . 'surgeModule/surge/ticket_detail_form?id='.$ticket_id);
