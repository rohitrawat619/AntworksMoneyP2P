<?php
    ...
    if($results)
    {
            ...
            $loan_amount_inword = $this->Borroweractionmodel->convert_number_to_words($loan_amount);
            ...
            echo $data = "<div id='loanagreements'><div>
                    <div class='col-md-12'>
                        <div class='row'>
                            <div class='welcome'>
                ...
                <div class='col-md-12'>
                    <div class='main-content'>
                        ...
                        <ol class='definations-list'>
                            <li>For providing the Peer to Peer Lending Platform and providing incidental services like monitoring the disbursements and repayments,Antworks shall be entitled to periodical Assistance Fees to be known as Lender's Assistance Fees, at the rate as specified in the website <a href='".base_url()."'>".$portal_name."</a> payable by the Lender granting the loan .<br>
                                The Lender'sAssistance Fee payable by the Lendershall be paid immediately as and when charged by Antworks (in line with the rate and schedule provided in the website <a href='".base_url()."'>".$portal_name."</a>) by way of online transfer to the Bank account of Antworks.</li>
                        ...
                        <ol class='definations-list'>
                            ...
                            <li>In case it is found that despite this undertaking, the Lender has taken any unfair, illegal, immoral, unethical means to enforce recovery of the Loan, then Antworksshall be at liberty to debar him from accessing <a href='".base_url()."'>".$portal_name."</a> apart from taking appropriate legal action against the Lender and / or give necessary assistance to the investigating agency.</li>
                        </ol>
                        ...
                        <ol class='definations-numlist'>
                            <li>He/she has read all the terms and conditions, privacy policy, and other material available at <a href='".base_url()."'>".$portal_name."</a> owned by Antworks herein.</li>
                            ...
                            <li>They have not provided any information which is incorrect or materially impairs the decision of Antworksto either register him / her or permits to lend him / her through the website of <a href='".base_url()."'>".$portal_name."</a>.</li>
