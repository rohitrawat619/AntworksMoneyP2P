			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="surge-list">
					<ul class="invest-details">
						...
						<li>Amount</li> <li> <span><?php echo $redeemReqestData['final_amount']; ?></span></li>
						
						<li>Bank Name</li> <li> <span><?php echo $redeemReqestData['bank_name']; ?></span></li>
						
						<li>Account No.</li> <li> <span>XXXXX-<?php echo substr($redeemReqestData['account_number'],11); ?></span></li>
