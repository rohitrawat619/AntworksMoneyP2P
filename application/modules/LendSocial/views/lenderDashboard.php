		...
		<div class="col-md-12 col-xs-12"><h2 class="dash-hd">View Current Investments</h2></div>
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="surge-list">
					<p class="investmentno">Investment No.: <?php echo $current_investment['investment_No']; ?> <a href="investmentRequestList?q=<?php echo base64_encode(encrypt_string($current_investment['investment_No']))."&s=".base64_encode(encrypt_string($current_investment['scheme_name']));?>">Details</a> </p>
