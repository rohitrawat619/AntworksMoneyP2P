        ...
        if(!empty($_POST))
         {
            ...
            {
                $result = $this->Livesearchmodel->search();
                  ...
                  foreach ($result AS $res)
                   {
                    $data[] ="<tr>
                            ...
                            <td><form method='post' action='".base_url()."/p2precovery//p2precovery/sendsms'>
                            ...
                            <td>
                            <a class='btn btn-success' href='".base_url()."p2precovery//p2precovery/sendemi/".$res['bid_registration_id']."'>Payment</a></td>
                      </tr>";
                    $i++; }
