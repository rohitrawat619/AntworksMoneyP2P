        ...
        <div class='main-content'>
            ...
            <div class='table-responsive'>
                <table class='table table-bordered'>
                    ...
                    <tr>
                        <td class='col-md-4'>Esign- <?=  $agreement_date_time_stamp ?></td>
            ...
            <ol class='definations-numbrlist'>
                <li>THAT I have taken a Loan of an amount Rs. <?=  $loan_amount ?>./- (Rupees <?=  $loan_amount_inword ?>) for a tenure of <?=  $result['TENORMONTHS'] ?>.months from Sri <?=  $result['LENDER_fNAME'] ?> by virtue of Loan Agreement No. LAN <?=  $result['PLRN'] ?> dated <?=  $agreement_date_time_stamp ?></li>
            ...
            <p>This has reference to the Loan of Rs <?=  $loan_amount ?>.for the tenure <?=  $result['TENORMONTHS'] ?>at the rate of interest of <?=  $result['LOAN_Interest_rate'] ?>% taken by you ('Borrower') from me ('Lender') by virtue of a Loan Agreement vide LAN <?=  $result['PLRN'] ?> dated <?=  $agreement_date_time_stamp ?> ('the Loan') through <a href='<?= base_url() ?>'><?= $portal_name ?></a>.</p>
            ...
            <p>This has reference to the Loan of Rs <?=  $loan_amount ?> for the tenure <?=  $result['TENORMONTHS'] ?> at the rate of interest of <?=  $result['LOAN_Interest_rate'] ?>% taken by you ('Borrower') from <?=  $result['LENDER_fNAME'] ?> ('Lender') by virtue of a Loan Agreement vide LAN <?=  $result['PLRN'] ?> dated <?=  $agreement_date_time_stamp ?> ('the Loan') through us <a href='<?= base_url() ?>'><?= $portal_name ?></a>.</p>
