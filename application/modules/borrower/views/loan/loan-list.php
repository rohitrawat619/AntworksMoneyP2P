	...
	<div class="col-md-12 m-t-40 collapse" id="collapseExample">
		<div class="table-responsive kyc-main">
			<table class="table m-t-30 table-bordered kyc-main">
				...
				<?php if($lists[0]['borrower_emi_information']) {foreach($lists[0]['borrower_emi_information'] AS $loan_info){?>
					<tr>
						<td><?php echo $this->session->userdata('name') ?></td>
						<td><?php echo $lists[0]['loan_no']; ?></td>
						<td><?php echo $lists[0]['admin_acceptance_date']; ?></td>
						<td><?php echo $loan_info['emi_principal']; ?></td>
						<td><?php echo $loan_info['emi_amount']; ?></td>

						<td><?php echo count($lists[0]['borrower_emi_information']) ?></td>
						<td><?php echo $loan_info['emi_date']; ?></td>
					</tr>
				<?php }} ?>
			</table>
		</div>
