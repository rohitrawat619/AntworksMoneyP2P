...
<div class="col-md-12 col-sm-12 col-xs-12 m-t-30">
    ...
    <div class="table-responsive">
        <table id="example23" class="table table-bordered table-hover table-striped">
			...
			<span><b>* note if you want processing fee by System then blank processing fee else enter gross amount</b></span>
			<form action="<?php echo base_url(); ?>creditops/accept_bid" method="post">
                ...
                <td><?php
                    ...
                    ?> Days</td>
					<td><input type="text" name="processing_fee" id="processing_fee" class="form-control" placeholder="Processing Fee IN Gross Amount"></td>
                <td>
