                            ...
                            <div class="col-md-12 credit-data" style="text-align: left !important;">
                                ...
                                <div class="row persnl-main">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="credit-data-nm">Experian Report Name :
                                            <span><?= $rating['experian_user_first_name'].' '.$rating['experian_user_last_name']; ?></span>
                                        </div>
                                        <div class="credit-data-nm">Age
                                            : <span><?php
                                                $dob = $rating['dateOfBirth'];
                                                $age = date('Y-m-d', strtotime($dob));
