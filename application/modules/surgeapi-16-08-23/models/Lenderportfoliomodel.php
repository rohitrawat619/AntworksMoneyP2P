<?php
class Lenderportfoliomodel extends CI_Model {
    ...
    public function total_principal_outstanding($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            return $result = $query->row()->total_principal_outstanding;
        }
        else{
            return false;
        }
    ...
    public function total_principal_recieved($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            return $result = $query->row()->total_principal_recieved;
        }
        else{
            return false;
        }
    ...
    public function total_principal_delayed($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            return $result = $query->row()->total_principal_delayed;
        }
        else{
            return false;
        }
    ...
    public function total_interest_recieved($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            return $result = $query->row()->total_interest_recieved;
        }
        else{
            return false;
        }
    ...
    public function total_other_payment_recieved($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
           return $result = (array)$query->row()->total_principal_outstanding;
    ...
    public function total_no_of_closed_loans($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            return $query->row()->total_no_of_closed_loans;
        }
        else{
            return false;
        }
    ...
    public function past_due_30_89days($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            return $result = $query->row()->past_due_30_89days;
    ...
    public function past_due_90_180days($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            return $result = $query->row()->past_due_90_180days;
    ...
    public function past_due_plus_180days($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            return $result = $query->row()->past_due_plus_180days;
    ...
    public function totalInvestment($lenderId)
    {
        ...
        if($this->db->affected_rows()>0)
        {
            ...
            $remainningAmount = $this->remainningAmount($lenderId);
    ...
    {
        $totalInvestment = $this->totalInvestment($lenderId);
...
//        echo $this->db->last_query(); exit;
    ...
    public function loan_summary($lenderId, $limit, $start)
    {
    ...
    public function accountSummary($lenderId)
    {
        $query = $this->db->select()->get_where('p2p_lender_main_balance', array('lender_id'=>$lenderId));
        $account_balance = $query->row()->account_balance;

        return array(
            'account_balance'=>$account_balance?$account_balance:0,
            'inFundingnotes'=>$this->total_amount_invested($lenderId),
            'outstandingPrincipal'=>$this->total_principal_outstanding($lenderId),
            'accuredInterest'=>$this->total_interest_recieved($lenderId),
        );
    }
