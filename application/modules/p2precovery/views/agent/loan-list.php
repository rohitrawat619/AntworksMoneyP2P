				...
				<div class="m-t-30">
					<div class="m-t-30">
						<div class="right-page-header">
							<form method="post" id="search_emi" action="<?php echo base_url(); ?>p2precovery/agentrecovery/search">
								<div class="col-md-12">
<!--									<div class="col-md-3">-->
							...
							<?php if ($loan_list) {
								...
								foreach ($loan_list AS $laon) {
									...
									<tr>
										...
										<td><a href="<?php echo base_url(); ?>p2precovery/agentrecovery/loandetails/<?php echo $laon['loan_no'] ?>" target="_blank" class="openBtn"
