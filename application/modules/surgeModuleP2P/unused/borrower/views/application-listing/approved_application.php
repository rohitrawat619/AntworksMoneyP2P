          ...
          <div class="scrollable">
            <div class="table-responsive">
              <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="100">
                ...
                <div class="col-md-3">
                <form action="<?php echo base_url(); ?>p2padmin/send_to_escrow_for_disbursement" method="post">
                    <input type="submit" class="form-control" name="submit" value="send-to-escrow">
                </form>
                </div>
            </div>
          </div>
