...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                <form method="post" action="../borrower/action"
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <a href="<?= base_url('sample-files/p2p_list_company.csv') ?>">Download Sample CAT List
                            File.</a> &nbsp;
                        <a href="../borrower/company_list" target="_blank">View CAT List ?</a>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <a href="<?= base_url('sample-files/negative_pincode_list.csv') ?>"> Download Sample File
                            Pincode. </a> &nbsp;
                        <a href="../borrower/negative_pincode_list" target="_blank"> View Pincode </a>
