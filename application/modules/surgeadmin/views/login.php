					...
					<div class="card-body">
						...
						<form method="post" autocomplete="off" action="<?= base_url('Surgeadmin/loginnow') ?>">
							<div class="mb-3">
								...
								<label><input type="radio" name="value" value="team" class="btn btn-primary" onclick="updateLoginOption()"> <button type="button" name="loginOption" class="btn btn-danger">Admin</button></label>
