...
<div class="white-box">
    ...
    <div class="container">
        <form id="upload_kyc_documents" action="<?php echo base_url() ?>borroweraction/borrowerkyc/borrowerkyc" method="post" enctype="multipart/form-data">
            <div class="col-md-12">
            <div class="table-responsive kyc-main">
                ...
                <table class="table table-bordered kyc-main table-responsive">
                    ...
                    <tr>
                            ...
                            <td class="col-md-4"><input class="form-control" type="text" name="pan" id="pan" value="<?=$info['pan']?>" placeholder="Pan No" maxlength="10" readonly>
            ...
            <input type="submit" class="btn btn-primary" id="verify_pan" name="verify_pan" value="Upload">
        </div>
        </form>
        <div class="col-md-6">
            <a href="<?php echo base_url(); ?>borrowerprocess/credit-bureau">
