<div class="mytitle row">
	...
	<div class="white-box">
		<div class="col-md-12">
			<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam rhoncus, felis interdum condimentum consectetur, nisl libero elementum eros, vehicula congue lacus eros non diam. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus mauris lorem, lacinia id tempus non, imperdiet et leo. Cras sit amet erat sit amet lacus egestas placerat.</p>
			...
			<div class="table-responsive kyc-main">
				<table class="table m-t-30 table-bordered kyc-main">
					...
					<tr>
						<td>Amit Kumar</td>
						<td>50000</td>
						<!--td><input type="checkbox" id='regular' name="optradio"></td-->
						<td><a role="button" data-toggle="collapse" href="#loanagreement" aria-expanded="false" aria-controls="loanagreement" class="btn btn-success m-r">View Loan Document</a></td>
					</tr>
					<tr>
						<td>Raj Singh</td>
						<td>50000</td>
				...
				<!--button class="btn btn-primary pull-right m-t-10 m-b-30" role="button" data-toggle="collapse" href="#loanagreement" aria-expanded="false" aria-controls="loanagreement">Loan Agreement</button-->
			</div>
		</div>
		<div class="col-md-12 m-t-40 collapse loanagreement" id="loanagreement">
			<div id="loanagreements">
			<div class="welcome">
				<p class="text-right">LAN: AW LAN#0000124</p>
    ...
    <p>THIS AGREEMENT for Loan dated Saturday-01-2019</p>
    <p>BETWEEN</p>

<p>Mr. / Ms. dinesh  sharma s/o / w/o Ramnivas Sharma Residing at Noida  Hapur UP 201301 having PAN  JDJDJ4543G, hereinafter referred to as 'the Borrower' and as more fully described in First Schedule hereunder(which expression shall unless it be repugnant to the context or meaning thereof be deemed to mean and include its successors and heirs) of the First Part</p>

<p>AND</p>

<p>Mr. / Ms. Dinesh  Sharmas/o / w/o Dinesh. Residing at Noida  Noida UP having PAN  DYIPS0326A, hereinafter referred to as'the Lender' and as more fully described in First Schedule hereunder(which expression shall unless it be repugnant to the context or meaning thereof be deemed to mean and include its successors, assigns and heirs) of the Second Part</p>
...
<p>AND WHEREAS the Lender and the Borrower coming to know their mutual requirements conducted their respective diligence and finally decided to grant and accept respectively a loan amounting to Rs 50000.</p>
...
<p>The principal amount of Loan covered under this Agreement is Rs 50000</p>

<p><strong>5.	Purpose of Loan</strong></p>
<p>The Borrower has declared that he is taking the loan for sds.</p>
...
<p>The tenure of the Loan shall be 6 months</p>

<p><strong>8.	Rate of Interest</strong></p>
<p>The Loan shall be subject to an interest @12% p.a.</p>
...
<li>Penal Interest referred to above shall be calculated @12% per annum (in addition to the rate of interest of the loan) for the period of delay till repayment of the entire overdue EMI amount. In case only the preceding EMI is overdue, the Penal Interest would be calculated on the overdue amount. In case more than one EMI is overdue, the Penal Interest would be calculated on the total outstanding loan amount.</li>
...
<li>In case no amount under this Agreement for Loan is disbursed by the Lenderwithin a period of 6 months from the date of this Agreement.</li>
...
<div class="table-responsive">
  <table class="table table-bordered">
  	<tbody><tr>
    	<td><span class="esign">e-SIGN</span> <br> 05/01/2019 11:27:45 <br>Borrower</td>
        <td>05/01/2019 11:27:45 <br>Lender</td>
    </tr>
    <tr>
    	<td>Witness</td>
        <td>Witness</td>
    ...
    <tr>
    	<td>05/01/2019 11:27:45 <br>Antworks</td>
        <td></td>
    </tr>
    <tr>
    	<td>Witness</td>
        <td>05/01/2019 11:27:45</td>
    </tr>
  </tbody></table>
</div>
<pagebreak>
...
<div class="table-responsive">
  <table class="table table-bordered">
    ...
    <tr>
    	<td>5.</td>
        <td>Address</td>
        <td>Noida  Hapur UP 201301</td>
    </tr>
    <tr>
    	<td>6.</td>
        <td>E-mail ID</td>
        <td>dinesh.knmiet@gmail.com</td>
    </tr>
    <tr>
    	<td>7.</td>
        <td>Mobile</td>
...
<div class="table-responsive">
  <table class="table table-bordered">
    ...
    <tr>
    	<td>5.</td>
        <td>Address</td>
        <td>Noida  Noida UP</td>
    </tr>
    <tr>
    	<td>6.</td>
        <td>E-mail ID</td>
        <td>dinesh@antworksmoney.com</td>
    </tr>
    <tr>
    	<td>7.</td>
        <td>Mobile</td>
...
<li>Loan Amount Rs.:50000</li>
<li>Loan Tenor 6</li>
<li>Rate of Interest Per Annum 12%</li>
<li>Monthly Instalment (EMI) RS-8627</li>
...
<div class="table-responsive">
  <table class="table table-bordered">
   ...
   <tr><td>Month 1</td><td>8627</td><td>07/January/2019</td><td>500</td><td>8127</td><td>41873</td></tr><tr><td>Month 2</td><td>8627</td><td>07/March/2019</td><td>419</td><td>8209</td><td>33664</td></tr><tr><td>Month 3</td><td>8627</td><td>07/April/2019</td><td>337</td><td>8291</td><td>25373</td></tr><tr><td>Month 4</td><td>8627</td><td>07/May/2019</td><td>254</td><td>8374</td><td>16999</td></tr><tr><td>Month 5</td><td>8627</td><td>07/June/2019</td><td>170</td><td>8457</td><td>8542</td></tr><tr><td>Month 6</td><td>8627</td><td>07/July/2019</td><td>85</td><td>8542</td><td>0</td></tr>
   </tbody></table>
</div>
<pagebreak>
<div class="text-center">
...
<p>On demand, I, Mr./Miss/Mrs. Dinesh  Sharma (Hereinafter the 'Borrower') S/o/D/o/W/o, Dineshhereby promise to pay to
Mr./Mrs./Miss dinesh  sharma S/o/D/o/W/o, Ramnivas Sharma, (referred to as the Lender in the Loan Agreement Dated 05/01/2019 11:27:45 inter-alia between me as Borrower and the Lender) the sum of Rs. 50000(Rupees fifty  thousands   only) in 6 monthly instalments, to be paid every month together with interest at the rate of 12% per annum, from the date of these presents, payable in any part of India for value received.</p>
...
<p>I, Sri dinesh  sharma(PAN: JDJDJ4543G), S/o Ramnivas Sharma, residing at do hereby undertake as under:</p>

<ol class="definations-numbrlist">
	<li>THAT I have taken a Loan of an amount Rs. 50000./- (Rupees fifty  thousands  ) for a tenure of 6.months from Sri Dinesh  Sharma.by virtue of Loan Agreement No. LAN LAN#0000124 dated 05/01/2019 11:27:45</li>
    <li>THAT in the said Agreement Sri Dinesh  Sharma. has been identified as the Lender and myself as Borrower and <a href="http://www.p2ploan.antworksmoney.com">www.p2ploan.antworksmoney.com</a> as Antworks</li>
...
<p>This has reference to the Loan of Rs 50000.for the tenure 6at the rate of interest of 12% taken by you ('Borrower') from me ('Lender') by virtue of a Loan Agreement vide LAN LAN#0000124 dated 05/01/2019 11:27:45 ('the Loan') through <a href="http://www.p2ploan.antworksmoney.com">www.p2ploan.antworksmoney.com</a>.</p>
...
<p>This has reference to the Loan of Rs 50000 for the tenure 6 at the rate of interest of 12% taken by you ('Borrower') from Dinesh  Sharma ('Lender') by virtue of a Loan Agreement vide LAN LAN#0000124 dated 05/01/2019 11:27:45 ('the Loan') through us <a href="http://www.p2ploan.antworksmoney.com">www.p2ploan.antworksmoney.com</a>.</p>
...
</pagebreak></pagebreak></pagebreak></pagebreak></pagebreak></pagebreak></pagebreak></div>
