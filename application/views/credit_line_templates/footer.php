		...
		<div class="" style="margin-bottom: 0px !important; padding:10px">
				...
				<div class="single-footer-widget link-widget">
					<div class="menu-footer-menu-container">
						<ul id="menu-footer-menu" class="menu">
							<li><a href="https://www.antworksp2p.com/about-us">About Us</a></li>
							<li><a href="https://www.antworksp2p.com/fees-and-charges">Fees & Charges</a></li>
							<li><a href="https://www.antworksp2p.com/lender/portfolio-performance">Portfolio Performance</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6">
				<div class="single-footer-widget link-widget">
					<div class="menu-footer-menu-container">
						<ul id="menu-footer-menu" class="menu">
							<li><a href="https://www.antworksp2p.com/contact-us">Contact Us</a></li>
							<li><a href="https://www.antworksp2p.com/privacy-and-policy">Privacy Policy</a></li>
							<li><a href="https://www.antworksp2p.com/affiliates">Affiliates</a></li>
			...
			<div class="col-md-3 col-sm-3 col-xs-6">
				<div class="single-footer-widget link-widget">
					<div class="menu-footer-menu-container">
						<ul id="menu-footer-menu" class="menu">
							<li><a href="https://www.antworksp2p.com/how-it-works">How it works</a></li>
							<li><a href="https://www.antworksp2p.com/term-and-conditions">Term & Conditions</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6">
				<div class="single-footer-widget link-widget">
					<div class="menu-footer-menu-container">
						<ul id="menu-footer-menu" class="menu">
							<li><a href="https://www.antworksp2p.com/fair-practices-code">Fair Practices Code</a></li>
							<li><a href="https://www.antworksp2p.com/faq">FAQs - Investor Antworks Money </a></li>
						</ul>
					</div>
				</div>
			</div>
...
<section class="footer-bottom">
	<div class="container">
		<div class="copyright pull-left">
			...
			<p>Copyrights © Antworks P2P Financing 2019-2024 All Rights Reserved.</p>
		</div>
		<!-- /.copyright pull-left -->
...
<script src="https://www.antworksp2p.com/assets/assets/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<script src="https://www.antworksp2p.com/assets/js/custom.js"></script>
</body>
</html>