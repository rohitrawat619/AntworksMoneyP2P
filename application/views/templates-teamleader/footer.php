...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2020 <a href="javascript:void(0)">Antworks P2P</a>.</strong> All rights
    reserved.
</footer>
...
<!-- ./wrapper -->
    ...
    <script src="<?=base_url();?>assets-p2padmin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script>
        $(function () {
            /* ChartJS
             * -------
    ...
    <!--<script src="<?=base_url();?>assets-p2padmin/assets/js/borrower.js"></script>
	<script src="<?=base_url();?>assets-p2padmin/dist/js/validate.js"></script>-->
</body>
</html>
