...
<head>
    ...
    <title>P2P Admin 1.0 | Dashboard</title>
    ...
    <link rel="stylesheet" href="<?=base_url();?>assets-p2padmin/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
...
<!-- Top Navigation -->
    <header class="main-header">
        ...
        <a href="javascript:void(0)" class="logo">
            ...
            <span class="logo-mini"><b>P</b>2P</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Ant</b>Works P2P</span>
        </a>
