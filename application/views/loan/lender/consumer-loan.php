...
<style>
	...
	.banner-section.personalloan1 {background: url(../assets/img/lender-consumerloan-banner.jpg) !important; background-repeat:no-repeat !important; background-position: 50% 60% !important; background-size: cover !important;}
			...
			<div class="container">
				<div class="hero-content">
					<div class="col-md-8 nopadding banner-desc">
						...
						<a class="btn btn-action wow fadeInUp" data-wow-delay="0.2s" href="javascript:void(0);">Get return upto 36%</a>
						<p class="banr-txt">Click here to participate in <span>Consumer Finance Lenders Club</span></p>
					</div>
