<section class="main-bannerp2p">
	<div class="container">
		<h2 class="banner-hd"><span style="display: block; text-align: center"><img src="<?php echo base_url('assets/img/nbfc.png'); ?>"></span>Best P2P loan offers on Antworks P2P Financing</h2>
		<div>
		  <!-- Nav tabs -->
		  <ul class="nav nav-tabs" role="tablist">
			  <li role="presentation"><a href="<?php echo base_url(); ?>lender">Lender</a></li>
			<li role="presentation" class="active"><a href="#Borrower" aria-controls="home" role="tab" data-toggle="tab">Borrower</a></li>

		  </ul>

		  <!-- Tab panes -->
		  <div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="Borrower">
				<h4 class="banr-hd">Register Now
                    (Get Loan at as low as 12% p.a.)</h4>
                <form action="<?php echo base_url(); ?>borrower-registration" method="post">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <label>at ROI (Rate of Interest) %</label>
                        <div class="slider_bg">
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <input type="submit" class="btn-getstarted" value="Get Started"/>
                    </div>
                </form>
			</div>
			<div role="tabpanel" class="tab-pane" id="Lender">
				<h4 class="banr-hd">Register Now
                    (Get Returns upto 24%)</h4>
                <form action="<?php echo base_url(); ?>lender-registration" method="post">
                    <div class="col-md-4 col-xs-12">
                        <label>Willing to Lend</label>
                        <div class="slider_bg">
                            <div id="interest-calc"  class="noUi-target noUi-ltr noUi-horizontal"></div>
                            <input type="text" name="loan_amount_lender" id="interest-range-calc" value="4"/>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <label>For</label>
                        <div class="slider_bg">
                            ...
                            <input type="text" name="tenor_lender" id="tenor-range-calc" value="6" />
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <label>at ROI (Rate of Interest)</label>
                        <div class="slider_bg">
                            <div id="emi-calc"  class="noUi-target noUi-ltr noUi-horizontal"></div>
                            <input id="slider_emi" name="emi_lender" value="" type="text">
                        </div>
                    </div>
                    <div class="col-md-12 col-xs-12">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
...
<section class="container-fluid prod-thumbs">
	<div class="container wow fadeInUp animated animated" data-wow-delay="0.3s"><h2 class="blogs-hd">Products</h2></div>
	<div class="row">
		<div class="col-md-4">
			<a href="<?php echo base_url(); ?>business-loan"><img src="<?php echo base_url();?>assets/img/businessloan-th.jpg" alt="Loan" class="img-responsive"></a>
		</div>
		<div class="col-md-4">
			<a href="<?php echo base_url(); ?>personal-loan"><img src="<?php echo base_url();?>assets/img/personalloan-th.jpg" alt="Loan" class="img-responsive"></a>
		</div>
		<div class="col-md-4">
			<a href="<?php echo base_url(); ?>consumer-loan"><img src="<?php echo base_url();?>assets/img/consumerloan-th.jpg" alt="Loan" class="img-responsive"></a>
		</div>
	</div>
</section>
