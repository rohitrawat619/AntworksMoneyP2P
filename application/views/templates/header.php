...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/CryptoJS/rollups/sha512.js"></script>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-139722272-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-139722272-1');
    </script>

    <meta name="google-site-verification" content="DBTl-KNUMcIgZBtOPbCBBEbI_smgRGWqeWBpdDZVSgs" />
</head>
<body>
