...
<!--			<li class="profile1"><a href="--><?//=base_url();?><!--p2padmin/appdetails"><i class="fa fa-user"></i> <span>App Details</span>-->
			<li class="profile1"><a href="<?=base_url();?>p2padmin/p2pmis/borrowerstatus"><i class="fa fa-user"></i> <span>Borrower status</span>
