...
class Welcome extends CI_Controller {
	...
	public function aphit($data)
	{
		...
		$apiEndpoint = "http://localhost/invest/index.php/invest/".$data['ap'];
		unset($data['ap']);
...
return $response;
	...
	function registerNow()
	{
		...
		// exit;
				...
				$apiEndpoint = 'http://localhost/invest/index.php/invest/user_reg';
...
public	function Partnerlogin()
	...
	public function editdetailsbteam()
	{
