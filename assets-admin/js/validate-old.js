...
function add_user_valid()
{
	...
	{
		alert("Password cann't be less than 8 digits.");
		$("#password").focus();
		return false;
	}
...
function validate_finish_fc()
{
	...
	{
		$("#business_type-error").html("Please select this field.");
		$("#business_type").focus();
		return false;
	}
	else if($('#already_in_business').val()=="")
	{
		$("#already_in_business-error").html("Please select this field.");
...
function validateCorp()
{
	...
	else if(($("#company_password").val()!="") && $("#company_password").val().length<8)
	{
		alert("Password cann't be less than 8 digits.");
		$("#company_password").focus();
		return false;
